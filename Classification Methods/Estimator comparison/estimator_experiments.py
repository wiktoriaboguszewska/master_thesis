...
# Runner functions
def estimate_em(X_tr, y_tr, X_te, clf_name):
    _, q1 = em(X_tr, y_tr, X_te, clf_name=clf_name, epochs=200, q_init=0.5, tol=1e-4)
    return q1

def estimate_tc(X_tr, y_tr, X_te, clf_name):
    _, q1, _ = threshold_calibration(X_tr, y_tr, X_te, clf_name=clf_name)
    return q1
